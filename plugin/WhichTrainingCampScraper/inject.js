...
function run(){
	console.log('run');
	var sportNames =new SportsNames(['cycling', 'triathlon', 'duathlon', 'swimrun']);
	var csvMappings={Name:'name',Location:'location',
Phone:'phone',Sports:'sports',Link:'website',
	Facebook:'facebooks',
	Twitters:'twitters',
	Lat:'latLng.lat',
	Lng:'latLng.lng',
	'Videos':'youtubes'};var csvGenerator = new CsvGenerator({mappings:csvMappings, fileName: 'scrapedVenues.csv'});
	var venues = new Venues();
	venues.getVenues(sportNames, function(venue){ 
		csvGenerator.add(venue);
	}, function(){
		console.log('done');
